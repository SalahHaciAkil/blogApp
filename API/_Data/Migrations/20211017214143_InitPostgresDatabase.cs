...
{
    public partial class InitPostgresDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostrName = table.Column<string>(type: "text", nullable: true),
                    PostrPhoto = table.Column<string>(type: "text", nullable: true),
                    PostCategory = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostrId = table.Column<int>(type: "integer", nullable: false),
                    PostrName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserPhoto = table.Column<string>(type: "text", nullable: true),
                    UserName = table.Column<string>(type: "text", nullable: true),
                    LikedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Read = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersPostLikes", x => new { x.UserId, x.PostId });
                    table.ForeignKey(
